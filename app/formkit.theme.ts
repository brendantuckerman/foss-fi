...
/**
  ...
  *
  * @checksum - 705205eae796384924be460110837da3e97b2d8a8d0aa61f99e4fe083750462b
  * @variables - radius=rounded-md,accentColor=violet,colorTemperature=zinc,spacing=2,scale=base,inputShadow=shadow-md,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-[20em],tagRadius=rounded-sm,swatchRadius=rounded-sm
  * @theme - regenesis
  **/
